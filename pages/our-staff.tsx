...
const OurStaff = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://cdn.contentful.com/spaces/${PRIVATE_DATA.spaseID}/entries?content_type=oceanInsightCenterCounselors&access_token=${PRIVATE_DATA.accessId}`,
      )
      .then((response) => {
    ...
    axios
      .get(
        `https://cdn.contentful.com/spaces/${PRIVATE_DATA.spaseID}/entries?content_type=oceanInsightCenterPrescribers&access_token=${PRIVATE_DATA.accessId}`,
      )
      .then((response) => {
  ...
  return (
    <>
      <Head>
        <title>
          Ocean Insight Center Mental Health Clinic - Call Today | Our Staff
        </title>
      </Head>
      <OtherHeader />
      <WrapperHeader
